...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    JButton next;
    JRadioButton syes,sno,eyes,eno,male,female,married,unmarried,other;
    ...
    SignupTwo(String formno){
        ...
        String incomecategory[] = {"Null", "< 150000", "< 250000", "< 500000", "Upto 100000"};
        ...
        setSize(850, 800);
        setLocationRelativeTo(null);   // also can use setLocation(350, 200);
        setVisible(true);
